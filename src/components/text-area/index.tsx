...
import { PlaceholderUpdate } from "../utils/placeholder";
...
export const TextAreaInput: React.FC<TextAreaInputProps> = ({
  ...
  const [_showSubLebel, set_ShowSubLebel] = useState<boolean>(showSubLebel);
  ...
  return (
    <DrawerContextProvider>
      <FormGroup className="border border-primary rounded p-3">
        ...
        <div className="d-flex justify-content-between align-items-center mt-2">
          ...
          <div className="d-flex align-items-center gap-3">
            <Button color="link" className="p-0" onClick={onDelete}>
              <FiTrash2 size={18} />
            </Button>
            <Button color="link" className="p-0" onClick={onDuplicate}>
              <FiCopy size={18} />
            </Button>

            <DrawerOpener drawerId="unique-id-text-area">
              <Button color="link" className="p-0" onClick={onSettings}>
                <FiSettings size={18} />
              </Button>
            </DrawerOpener>
      ...
      <DrawerRight drawerId="unique-id-text-area">
        <PlaceholderUpdate
